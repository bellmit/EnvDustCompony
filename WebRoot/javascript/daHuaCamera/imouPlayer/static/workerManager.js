var WorkerManager = function () {
    ...
    a.prototype = {
        init: function (a, b) {
            ...
            l = new Worker("./imouPlayer/static/videoWorker.js"), m = new Worker("./imouPlayer/static/audioWorker.js"), l.onmessage = d, m.onmessage = e, p = new StreamDrawer(zb, this, S), H = IvsDraw(), p.setResizeCallback(s), xb = document.getElementById("count-fps"), wb = document.getElementById("span-fps")
